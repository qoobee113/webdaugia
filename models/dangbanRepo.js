...
exports.dangsanpham123 = function(entity) {
    ...
    var sql = mustache.render(
        ...
        'INSERT into sanpham VALUES (null,{{chonloaisanpham}},"{{tensanpham}}","'+ entity.motangangon+'","'+entity.motachitiet+'",{{giakhoidiem}},"'+entity.link1+'","'+entity.link2+'","'+entity.link3+'",{{giamuangay}},{{idnguoiban}},"'+a+'","'+b+'",null,"{{buocgia}}",0,1,'+entity.tudonggiahan+')',
        /*'select * from user',*/
        entity
    );
...
exports.dangsanphamtest = function(entity) {

    var sql = mustache.render(
        'INSERT into sanpham VALUES (null,{{chonloaisanpham}},"{{tensanpham}}","'+ entity.motangangon+'","'+entity.motachitiet+'",{{giakhoidiem}},"'+entity.link1+'","'+entity.link2+'","'+entity.link3+'",{{giamuangay}},{{idnguoiban}},"{{thoigiandang}}","{{thoigiandang}}",null,"{{buocgia}}",0,1,'+entity.tudonggiahan+')',
        entity
    );
    return db.insert(sql);
